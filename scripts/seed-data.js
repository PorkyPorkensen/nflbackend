...
const nflTeamsData = [
  // AFC Teams
  { espn_team_id: 2, name: 'Buffalo Bills', abbreviation: 'BUF', location: 'Buffalo', conference: 'American Football Conference', division: 'AFC East', playoff_seed: 6, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/buf.png', primary_color: '#00338D', secondary_color: '#C60C30' },
  ...
  { espn_team_id: 17, name: 'New England Patriots', abbreviation: 'NE', location: 'New England', conference: 'American Football Conference', division: 'AFC East', playoff_seed: 2, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/ne.png', primary_color: '#002244', secondary_color: '#C60C30' },
  ...
  { espn_team_id: 24, name: 'Los Angeles Chargers', abbreviation: 'LAC', location: 'Los Angeles', conference: 'American Football Conference', division: 'AFC West', playoff_seed: 7, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/lac.png', primary_color: '#0080C6', secondary_color: '#FFC20E' },
  { espn_team_id: 7, name: 'Denver Broncos', abbreviation: 'DEN', location: 'Denver', conference: 'American Football Conference', division: 'AFC West', playoff_seed: 1, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/den.png', primary_color: '#FB4F14', secondary_color: '#002244' },
  ...
  { espn_team_id: 23, name: 'Pittsburgh Steelers', abbreviation: 'PIT', location: 'Pittsburgh', conference: 'American Football Conference', division: 'AFC North', playoff_seed: 4, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/pit.png', primary_color: '#FFB612', secondary_color: '#101820' },
  ...
  { espn_team_id: 34, name: 'Houston Texans', abbreviation: 'HOU', location: 'Houston', conference: 'American Football Conference', division: 'AFC South', playoff_seed: 5, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/hou.png', primary_color: '#03202F', secondary_color: '#A71930' },
  ...
  { espn_team_id: 30, name: 'Jacksonville Jaguars', abbreviation: 'JAX', location: 'Jacksonville', conference: 'American Football Conference', division: 'AFC South', playoff_seed: 3, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/jax.png', primary_color: '#101820', secondary_color: '#D7A22A' },
  ...
  { espn_team_id: 9, name: 'Green Bay Packers', abbreviation: 'GB', location: 'Green Bay', conference: 'National Football Conference', division: 'NFC North', playoff_seed: 7, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/gb.png', primary_color: '#203731', secondary_color: '#FFB612' },
  ...
  { espn_team_id: 3, name: 'Chicago Bears', abbreviation: 'CHI', location: 'Chicago', conference: 'National Football Conference', division: 'NFC North', playoff_seed: 2, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/chi.png', primary_color: '#0B162A', secondary_color: '#C83803' },

  { espn_team_id: 21, name: 'Philadelphia Eagles', abbreviation: 'PHI', location: 'Philadelphia', conference: 'National Football Conference', division: 'NFC East', playoff_seed: 3, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/phi.png', primary_color: '#004C54', secondary_color: '#A5ACAF' },
  ...
  { espn_team_id: 29, name: 'Carolina Panthers', abbreviation: 'CAR', location: 'Carolina', conference: 'National Football Conference', division: 'NFC South', playoff_seed: 4, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/car.png', primary_color: '#0085CA', secondary_color: '#101820' },

  { espn_team_id: 14, name: 'Los Angeles Rams', abbreviation: 'LAR', location: 'Los Angeles', conference: 'National Football Conference', division: 'NFC West', playoff_seed: 5, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/lar.png', primary_color: '#003594', secondary_color: '#FFA300' },
  { espn_team_id: 26, name: 'Seattle Seahawks', abbreviation: 'SEA', location: 'Seattle', conference: 'National Football Conference', division: 'NFC West', playoff_seed: 1, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/sea.png', primary_color: '#002244', secondary_color: '#69BE28' },
  ...
  { espn_team_id: 25, name: 'San Francisco 49ers', abbreviation: 'SF', location: 'San Francisco', conference: 'National Football Conference', division: 'NFC West', playoff_seed: 6, logo_url: 'https://a.espncdn.com/i/teamlogos/nfl/500/sf.png', primary_color: '#AA0000', secondary_color: '#B3995D' }
];
...
async function seedNFLTeams() {
  ...
  try {
    ...
    await pool.query('DELETE FROM bracket_predictions');
    await pool.query('DELETE FROM brackets');
